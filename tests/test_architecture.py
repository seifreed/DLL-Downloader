...
TEST_INTERNAL_IMPORT_ALLOWLIST = {
    ...
    "tests/test_structured_presenter.py",
...
TECHNICAL_ADAPTER_IMPORT_ALLOWLIST: dict[str, tuple[str, ...]] = {
    "dll_downloader/infrastructure/http/http_client.py": (
        ...
        "dll_downloader.infrastructure.validation",
        "dll_downloader.infrastructure.http.request_headers",
        "dll_downloader.infrastructure.http.response_stream",
        "dll_downloader.infrastructure.http.retry_policy",
    ...
    "dll_downloader/infrastructure/http/transport.py": (
        ...
        "dll_downloader.domain.errors",
        "dll_downloader.infrastructure.http_session",
        "dll_downloader.infrastructure.net",
        "dll_downloader.infrastructure.http.request_headers",
        "dll_downloader.infrastructure.http.retry_policy",
        "http_session",
        "request_headers",
